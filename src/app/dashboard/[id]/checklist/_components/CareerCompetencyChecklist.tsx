...
interface CareerCompetencyChecklistProps {
...
const CareerCompetencyChecklist: React.FC<CareerCompetencyChecklistProps> = ({
    scoreLabels,
    scores,
    onScoreChange,
    groupedQuestions,
...
export default CareerCompetencyChecklist; 
...
interface AcademicCompetencySectionProps {
    questions: ChecklistQuestion[];
    scores: Record<number, number>;
    onScoreChange: (questionId: number, score: number) => void;
}

export default function AcademicCompetencySection({ questions, scores, onScoreChange }: AcademicCompetencySectionProps) {
    // 카테고리별로 그룹화
    ...
    return (
        <section className="bg-white rounded-lg p-4 shadow-sm">
            <h2 className="text-xl font-bold text-gray-800 mb-4">학업역량</h2>
